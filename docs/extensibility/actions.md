...
| **outputDir** | string | Path to the output directory where workspace will be generated |
| **runtimes** | map | Map of awailable runtimes from which workspace will be generated by using the `useRuntime` field |
