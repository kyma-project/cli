...
```
  ...
  -z, --zones strings                  Zones is a list of availability zones that are used to evenly distribute the worker pool. eg. --zone="europe-west3-a,europe-west3-b" (default [europe-west3-a])
```
