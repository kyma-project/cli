...
The command offers more functionality, such as mounting ConfigMap or Secret, and adding inline environments or from source (ConfigMap, Secret, or file). More detailed descriptions and examples can be found while executing the `kyma app push --help` command.
