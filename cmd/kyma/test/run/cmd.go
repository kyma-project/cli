...
`,
	...
	cobraCmd.Flags().Int64VarP(&o.ExecutionCount, "count", "c", 1, "Number of execution rounds for each test in the suite. It is not possible to configure this value in parallel with `max-retries`.")
