...
`,
	...
	cobraCmd.Flags().Int64VarP(&o.MaxRetries, "max-retries", "", 0, "Defines how many times a given test is retried when it fails. A suite is marked as a Succeeded even if some test failed and then finally succeeded. The default value of 0 means that there are no retries of a given test.")
