...
`,
	...
	cobraCmd.Flags().StringVarP(&o.Name, "name", "n", "", "Name of the new test suite. If you don't specify the value for the `-n` flag, the name of the test suite name will be autogenerated.")
	cobraCmd.Flags().Int64VarP(&o.ExecutionCount, "count", "c", 1, "Number of execution rounds for each test in the suite. It is not possible configure this value in parallel with `max-retries`.")
