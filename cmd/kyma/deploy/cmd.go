...
func NewCmd(o *Options) *cobra.Command {
	...
	cobraCmd.Flags().BoolVar(&o.DryRun, "dry-run", false, "Alpha feature: Does not actually deploy, but renders manifests only. The generated resources are not enough to apply Kyma using kubectl, since components having custom installation routines (e.g. Istio) are not included.")
