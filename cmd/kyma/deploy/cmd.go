...
func NewCmd(o *Options) *cobra.Command {
	...
	cobraCmd.Flags().IntVarP(&o.WorkerPoolSize, "parallel", "", 4, "Set maximum number of workers to run simultaneously to deploy Kyma. By default, it is set to the value of 4.")
