...
func TestFunctionFlags(t *testing.T) {
	...
	require.Equal(t, "", o.CustomRuntimeImage, "The parsed value for the --custom-runtime-image flag not as expected.")
	...
	require.Equal(t, "custom-runtime-image", o.CustomRuntimeImage, "The parsed value for the --custom-runtime-image flag not as expected.")
