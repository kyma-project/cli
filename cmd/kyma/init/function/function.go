...
Use the flags to specify the initial configuration for your Function or to choose the location for your project.`,
	...
	cmd.Flags().BoolVar(&o.VsCode, "vscode", false, `Generate vscode settings containing config.yaml JSON schema for autocolmpletion (see "kyma get schema -h" for more info)`)
