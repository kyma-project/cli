...
FLAGS = -ldflags '-s -w -X github.com/kyma-project/cli/cmd/kyma/kymacmd/version.Version=$(VERSION) -X github.com/kyma-project/cli/cmd/kyma/kymacmd/install.DefaultKymaVersion=$(KYMA_VERSION)'
