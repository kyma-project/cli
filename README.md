...
| [`provision`](/docs/gen-docs/kyma_provision.md)| [`provision minikube`](/docs/gen-docs/kyma_provision_minikube.md)<br> [`provision gardener`](/docs/gen-docs/kyma_provision_gardener.md) <br> [`provision gcp`](/docs/gen-docs/kyma_provision_gcp.md) <br> [`provision azure`](/docs/gen-docs/kyma_provision_azure.md)| Provisions a new cluster on a platform of your choice. Currently, this command supports cluster provisioning on GCP, Gardener, and Minikube. | `kyma provision minikube`|
