...
// DockerClientService is an autogenerated mock type for the DockerClientService type
type DockerClientService struct {
	mock.Mock
}

// ArchiveDirectory provides a mock function with given fields: srcPath, options
func (_m *DockerClientService) ArchiveDirectory(srcPath string, options *archive.TarOptions) (io.ReadCloser, error) {
...
func (_m *DockerClientService) ImageBuild(ctx context.Context, buildContext io.Reader, options types.ImageBuildOptions) (types.ImageBuildResponse, error) {
...
func (_m *DockerClientService) ImagePush(ctx context.Context, image string, options types.ImagePushOptions) (io.ReadCloser, error) {
...
func (_m *DockerClientService) NegotiateAPIVersion(ctx context.Context) {
	_m.Called(ctx)
}
