...
type ComponentConfig struct {
	...
	BaseUrl              string // Registry URL to push the image to (optional)
...
func Build(fs vfs.FileSystem, c *ComponentConfig) (*ctf.ComponentArchive, error) {
	...
	if len(c.BaseUrl) != 0 {
		repoCtx, err := cdv2.NewUnstructured(cdv2.NewOCIRegistryRepository(c.BaseUrl, cdv2.ComponentNameMapping(c.ComponentNameMapping)))
		if err != nil {
