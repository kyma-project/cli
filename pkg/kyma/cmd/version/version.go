...
func NewCmd(o *Options) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Long: `Prints the version of the Kyma CLI and the version of the Kyma cluster the current KUBECONFIG points to. For details, see https://github.com/kyma-project/cli/tree/master/pkg/kyma/docs/install.md.
`,
